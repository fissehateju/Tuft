...
namespace Tuft.ControlPlane.DistributionWeights
{
    public class CaluclateWeights
    {
        ...
        public void getDynamicWeight(Packet pkt, Sensor sender)
        {
            ...
            {
                TDWeight = Settings.Default.TDWeight; //0.0429171855541718
                DirWeight = Settings.Default.DirWeight; //0.632487546699876
                PirpWeight = Settings.Default.PirpWeight; //0.256783935242839
                EnergyWeight = Settings.Default.EnergyWeight; //0.271200128700129
            }
